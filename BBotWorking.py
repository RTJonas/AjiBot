...
class TradingModel:
	...
	def plotData(self, buy_signals): #Changed "buy_signals = False"
		df = self.df
		...
		data = [candle, ssma, fsma, lbb] #Changed lowbb for lbb
	...
	def bollStrategy(self, i:int):
		''' If price is 1% below the Lower Bollinger Band, return True'''
